...
/**
 * <p>
 * конструктор ✅ {@link #MyVector(int)};
 * <p>
 * конструктор копирования ✅ {@link #MyVector(MyVector)};
 * <p>
 * добавления элемента в конец ✅ {@link #push};
 * <p>
 * удаление последнего элемента ✅ {@link #pop};
 * <p>
 * удаление элемента по индексу ✅ {@link #removeAt(int)};
 * <p>
 * вставка элемента по индексу ✅ {@link #insertAt(int, Object)};
 * <p>
 * изменение размера массива ✅ {@link #expand};
 * <p>
 * очистка массива (удаление всех элементов) ✅ {@link #clear};
 * <p>
 * получение текущего размера контейнера ✅ {@link #size};
 * <p>
 * получение максимального размера контейнера ✅ {@link #max};
 * <p>
 * при невозможности удаления элемента, доступа к элементу и т.п. должны
 * генерироваться исключения ✅;
 */
public class MyVector<T> implements Cloneable {
    private Object[] list;
    private int size = 0;
